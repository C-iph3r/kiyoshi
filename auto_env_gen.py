...
async def generate_session_string():
    ...
    if api_id and api_hash:
        try:
            ...
            print("The API_ID/API_HASH combination is invalid. Please check and try again.")
            sys.exit(1)
...
def generate_env():
    ...
    with open(".env", "w") as f:
        f.write(txt.strip())
    print("Successfully Generated .env File. Don't Forget To Save It For Future Uses.")
    ...
    async with TelegramClient(StringSession(string_session), api_id, api_hash) as client:
        try:
            ...
            if isdone.startswith("That I cannot do.") or "20 bots" in isdone:
                print(
                    "You Already Made 20 Bots In Your Current Account. You Have To Delete One Bot To Run This Script."
                )
                sys.exit(1)
            ...
            print("Authentication key error. Please update the Telethon library and try again.")
